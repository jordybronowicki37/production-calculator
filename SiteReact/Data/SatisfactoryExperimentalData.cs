...
public static class SatisfactoryExperimentalData
{
    ...
    public static void addData(Worksheet worksheet)
    {
        ...
        // Flora & Fauna
        var PHogRem = worksheet.GetOrGenerateProduct("Hog Remains");
        var PSpiRem = worksheet.GetOrGenerateProduct("Spitter Remains");
        var PStiRem = worksheet.GetOrGenerateProduct("Stinger Remains");
        var PHatRem = worksheet.GetOrGenerateProduct("Hatcher Remains");
        ...
        var PAliPro = worksheet.GetOrGenerateProduct("Alien Protein");
        ...
        var POrgDatCap = worksheet.GetOrGenerateProduct("Organic Data Capsule");
        ...
        var PSmoPow = worksheet.GetOrGenerateProduct("Smokeless Powder");
        ...
        var PGasNob = worksheet.GetOrGenerateProduct("Gas Nobelisk");
        var PPulNob = worksheet.GetOrGenerateProduct("Pulse Nobelisk");
        var PCluNob = worksheet.GetOrGenerateProduct("Cluster Nobelisk");
        var PNukNob = worksheet.GetOrGenerateProduct("Nuke Nobelisk");
        var PIroReb = worksheet.GetOrGenerateProduct("Iron Rebar");
        var PStuReb = worksheet.GetOrGenerateProduct("Stun Rebar");
        var PShaReb = worksheet.GetOrGenerateProduct("Shatter Rebar");
        var PExpReb = worksheet.GetOrGenerateProduct("Explosive Rebar");
        var PRifAmm = worksheet.GetOrGenerateProduct("Rifle Ammo");
        var PHomRifAmm = worksheet.GetOrGenerateProduct("Homing Rifle Ammo");
        var PTurRifAmm = worksheet.GetOrGenerateProduct("Turbo Rifle Ammo");
        ...
        worksheet.GetRecipeBuilder("Biomass (Alien Protein)")
            .AddInput(PAliPro, 15)
        ...
        worksheet.GetRecipeBuilder("Hatcher Protein")
            .AddInput(PHatRem, 20)
            .AddOutput(PAliPro, 20).Build();
        worksheet.GetRecipeBuilder("Hog Protein")
            .AddInput(PHogRem, 20)
            .AddOutput(PAliPro, 20).Build();
        ...
        worksheet.GetRecipeBuilder("Organic Data Capsule")
            .AddInput(PAliPro, 10)
        ...
        worksheet.GetRecipeBuilder("Spitter Protein")
            .AddInput(PSpiRem, 20)
            .AddOutput(PAliPro, 20).Build();
        ...
        worksheet.GetRecipeBuilder("Stinger Protein")
            .AddInput(PStiRem, 20)
            .AddOutput(PAliPro, 20).Build();
        ...
        worksheet.GetRecipeBuilder("Cluster Nobelisk")
            .AddInput(PNob, 7.5f)
            .AddInput(PSmoPow, 10)
        ...
        worksheet.GetRecipeBuilder("Gas Nobelisk")
            .AddInput(PNob, 5)
            .AddInput(PBio, 50)
        ...
        worksheet.GetRecipeBuilder("Homing Rifle Ammo")
            .AddInput(PRifAmm, 50)
        ...
        worksheet.GetRecipeBuilder("Pulse Nobelisk")
            .AddInput(PNob, 5)
            .AddInput(PCryOsc, 1)
        ...
        worksheet.GetRecipeBuilder("Rifle Ammo")
            .AddInput(PCopShe, 15)
            .AddInput(PSmoPow, 10)
        ...
        worksheet.GetRecipeBuilder("Shatter Rebar")
            .AddInput(PIroReb, 20)
            .AddInput(PQuaCry, 30)
        ...
        worksheet.GetRecipeBuilder("Stun Rebar")
            .AddInput(PIroReb, 10)
            .AddInput(PQui, 50)
        ...
        worksheet.GetRecipeBuilder("Explosive Rebar")
            .AddInput(PIroReb, 20)
            .AddInput(PSmoPow, 20)
            .AddInput(PStePip, 20)
        ...
        worksheet.GetRecipeBuilder("Nuke Nobelisk")
            .AddInput(PNob, 2.5f)
        ...
        worksheet.GetRecipeBuilder("Smokeless Powder")
            .AddInput(PBlaPow, 20)
