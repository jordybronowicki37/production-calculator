...
public static class SatisfactoryData
{
    public static void AddData(EntityContainer e)
    {
        ...
        // Flora & Fauna
        var PAliCar = e.GetOrGenerateProduct("Alien Carapace");
        var PAliOrg = e.GetOrGenerateProduct("Alien Organs");
        ...
        var PSpiReb = e.GetOrGenerateProduct("Spiked Rebar");
        var PRifCar = e.GetOrGenerateProduct("Rifle Cartridge");
        ...
        e.GetRecipeBuilder("Biomass (Alien Carapace)", MCon)
            .AddInput(PAliCar, 15)
            .AddOutput(PBio, 1500).Build();
        e.GetRecipeBuilder("Biomass (Alien Organs)", MCon)
